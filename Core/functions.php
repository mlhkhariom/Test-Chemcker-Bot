...
$url = "https://api.telegram.org/bot7094262622:AAFCYar457koN9VT-fg30ctE9EDhpkj-3-w/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
